...
import com.smit.pictureshow.LauncherSettings.Favorites;

public class Launcher2defineProvider extends ContentProvider {
    private static final String TAG = "Launcher.LauncherProvider";
    private static final boolean LOGD = false;

    private static final String DATABASE_NAME = "launcher2define.db";
    
    private static final int DATABASE_VERSION = 8;

    static final String AUTHORITY = "com.smit.pictureshow.settings";
    
    static final String EXTRA_BIND_SOURCES = "com.smit.pictureshow.settings.bindsources";
    static final String EXTRA_BIND_TARGETS = "com.smit.pictureshow.settings.bindtargets";

    static final String TABLE_FAVORITES = "favorites";
    static final String TABLE_LATEST = "latestuse";
    static final String TABLE_POSITIONORDER = "positionorder";
    ...
    public static void MysetTransactionSuccessful(){
    	mOpenHelper.getWritableDatabase().setTransactionSuccessful();
    }

    //处理完成
    public static void MyendTransaction(){
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            try{
                ...
                db.execSQL("CREATE TABLE latestuse (" +
                "_id INTEGER PRIMARY KEY," +
                "packagename TEXT," +
                "frequency INTEGER," +
                "datetime TEXT" +
                ");");
                //创建移动应用数据互换位置应用表
                db.execSQL("CREATE TABLE positionorder (" +
                        "_id INTEGER PRIMARY KEY," +
                        "packagename TEXT," +
                        "types INTEGER," +
                        "orderindex INTEGER" +
        ...
        //add by xuewei 
        private boolean addButton(SQLiteDatabase db, ContentValues values, TypedArray a){
        	values.put(Favorites.ITEM_TYPE, Favorites.ITEM_TYPE_BUTTON);
