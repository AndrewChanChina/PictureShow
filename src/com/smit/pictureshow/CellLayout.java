...
public class CellLayout extends ViewGroup {
	private boolean mPortrait;          //是否是竖屏

	private int mCellWidth;
	private int mCellHeight;

	private int mLongAxisStartPadding;  //x轴方向与屏幕左侧的距离
	private int mLongAxisEndPadding;    //x轴方向与屏幕右侧的距离

	private int mShortAxisStartPadding; //y轴方向与屏幕顶部的距离
	private int mShortAxisEndPadding;   //y轴方向与屏幕底部的距离

	private int mShortAxisCells;        //y轴方向等分数
	private int mLongAxisCells;         //x轴方向等分数
	...
	boolean[][] mOccupied;   //默认cellLayout被划分成16个小块，每个小块默认情况下没有被view占据
	...
	//根据x,y,spanX,spanY来确定view的布局及位置
